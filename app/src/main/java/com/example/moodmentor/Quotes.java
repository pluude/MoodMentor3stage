...
public class Quotes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else if (getName.equals("Motivated")) {
            quotesLists.addAll(QuotesData.getMotivQuotes());
        }
        else if (getName.equals("Happy")) {
            quotesLists.addAll(QuotesData.getHappyQuotesList());
        }
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //incrementing when pressing next, first quote position is zero
                currentQuotePosition++;
